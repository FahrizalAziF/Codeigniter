...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <div id="wrapper">
        ...
        <!-- Section: team -->
        <section id="kitab" class="container home-section bg-gray wow bounceInUp">
            <div class="kotak">
                <div class="row">
                        ...
                        <div style="background: #00d2d3;width: 100%; height: 150px;">
                            <div class="col-md-9 col-sm-6 col-lg-9 col-xs-12">
                                ...
                                <p class="pull-left" style="padding-top: 70px; color: white ; font-size: 30px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
                                    <b>Koleksi <?php echo  $this->session->userdata('nama_depan') ?>(<?= $total->jum ?>)</b></p>
                            </div>
    ...
    foreach ($kol as $b) :   ?>
        <div id="myModal<?php echo $b->id_buku ?>" class="modal fade" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: center;">
                        <div style="padding: 50px">
                            <form action="<?php echo base_url('pengguna/delete'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <button class="btn btn-danger" style="text-transform: capitalize; border-radius: 20px;font-size: 20px;" type="input">Hapus</button>
                                <a data-dismiss="modal" class="btn btn-info" style="text-transform: capitalize; border-radius: 20px;font-size: 20px;"> Tidak</a>
                            </form>
                        </div>
                    </div>
                    <!-- footer modal -->
