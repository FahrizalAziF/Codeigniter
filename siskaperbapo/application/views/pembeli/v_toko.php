<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="mb-4"> <i class="fas fa-store" aria-hidden="true"></i> Toko <?= $toko->nama_toko ?></h2>
            <p class="mb-5"> <i class="fas fa-store" aria-hidden="true"></i> Daftar Produk Toko <?= $toko->nama_toko ?> </p>
            <hr>
            <div class="row">
                <?php
                if ($toko->jml > 0) {
